...
// ============================================================
// G4L LIVE SYSTEM STATUS PANEL
// Approved artwork remains untouched.
// ============================================================

(() => {
  const panel = document.querySelector('.system-status-live-panel');
  if (!panel) return;

  // LIVE state
  const liveText = document.createElement('div');
  liveText.className = 'g4l-live-status-text';
  liveText.innerHTML = '<span class="g4l-live-dot"></span> LIVE';

  // Community counter
  const community = document.createElement('div');
  community.className = 'g4l-community-live-count';
  community.textContent = '4,286';

  // Last update clock
  const updated = document.createElement('div');
  updated.className = 'g4l-last-update';
